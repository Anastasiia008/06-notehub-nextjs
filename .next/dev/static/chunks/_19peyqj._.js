...
function NotesClient() {
    ...
    if ($[0] !== "8aedfe36516f7116b413c58c3acce98b985b7e07a3756453fe07754e86aeb021") {
        for(let $i = 0; $i < 36; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8aedfe36516f7116b413c58c3acce98b985b7e07a3756453fe07754e86aeb021";
    }
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ({
            "NotesClient[handlePageChange]": (selectedItem)=>{
                setPage(selectedItem.selected + 1);
            }
        })["NotesClient[handlePageChange]"];
        $[1] = t0;
    } else {
        t0 = $[1];
    }
    const handlePageChange = t0;
    let t1;
    ...
    let t2;
    if ($[3] !== debouncedSearch) {
        t2 = ({
            "NotesClient[handleSearchChange]": (value_0)=>{
                setSearch(value_0);
    ...
    const { data, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t3);
    let t4;
    if ($[8] !== data?.notes) {
        t4 = data?.notes ?? [];
        $[8] = data?.notes;
    ...
    let t5;
    if ($[10] !== handleSearchChange || $[11] !== search) {
    ...
    let t10;
    if ($[22] !== isError) {
        t10 = isError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NoteForm$2f$NoteForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            onCancel: {
                "NotesClient[<NoteForm>.onCancel]": ()=>setIsModalOpen(false)
            }["NotesClient[<NoteForm>.onCancel]"]
        }, void 0, false, {
            fileName: "[project]/app/notes/Notes.client.tsx",
            lineNumber: 168,
            columnNumber: 11
    ...
    let t15;
    if ($[30] !== t10 || $[31] !== t11 || $[32] !== t14 || $[33] !== t8 || $[34] !== t9) {
...
_s(NotesClient, "RBLNQ3u7Iab7FrXdtPh5am0Iqfo=", false, function() {
    return [
...
const Modal = (t0)=>{
    ...
    if ($[0] !== "2d0d95bbcb7564bc5e5e5e55c8255423f0c877f29b0cfacc328379e4b6dc9774") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2d0d95bbcb7564bc5e5e5e55c8255423f0c877f29b0cfacc328379e4b6dc9774";
    }
...
const validationSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().min(3, "Min 3 characters").max(50, "Max 50 characters").required("Title is required"),
...
const NoteForm = (t0)=>{
    ...
    if ($[0] !== "cb4501cb2d95ccf4b7e84e0d62efcb9e9b7f2993c8330d70126ac194cc3aaf7e") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cb4501cb2d95ccf4b7e84e0d62efcb9e9b7f2993c8330d70126ac194cc3aaf7e";
    }
    const { onCancel } = t0;
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    let t1;
    if ($[1] !== onCancel || $[2] !== queryClient) {
        t1 = {
    ...
    let t3;
    if ($[6] !== mutation.isPending || $[7] !== onCancel) {
        t3 = (t4)=>{
            const { isSubmitting } = t4;
...
function NoteList(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(10);
    if ($[0] !== "ee06a26147b8194b4f821916e90850bbfe06ef74524e50f453c029e3c24f349b") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ee06a26147b8194b4f821916e90850bbfe06ef74524e50f453c029e3c24f349b";
    }
    const { notes } = t0;
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    let t1;
...
function Pagination(t0) {
    ...
    if ($[0] !== "ddb2aa0a315faa6bf94b77a167b31fb934c7ed4f4b93798223512adca05c6644") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ddb2aa0a315faa6bf94b77a167b31fb934c7ed4f4b93798223512adca05c6644";
    }
    const { pageCount, onPageChange, forcePage } = t0;
    let t1;
    if ($[1] !== forcePage || $[2] !== onPageChange || $[3] !== pageCount) {
...
const SearchBox = (t0)=>{
    ...
    if ($[0] !== "255d2fa8c86a022734defea5ddcbdd057ac083f637d1000d65c7b39d8ba5e754") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "255d2fa8c86a022734defea5ddcbdd057ac083f637d1000d65c7b39d8ba5e754";
    }
...
const getAuthHeaders = ()=>{
    const token = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Im5hc3Rhc2lpYTAwOEBnbWFpbC5jb20i莱bnVsbCwiaWF0IjoxNzg3NTcxNzY5fQ.e5gJ_HXG5xSWaSnontXbGzja1f2KCP4r2QZaaoENNOw");
    return {
...
const fetchNoteById = async (id)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URL}/${id}`, {
        headers: getAuthHeaders()
    });
    return response.data;
};
const createNote = async (newNote)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(BASE_URL, newNote, {
        headers: getAuthHeaders()
    });
    return response.data;
};
const deleteNote = async (id)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_URL}/${id}`, {
        headers: getAuthHeaders()
    });
    return response.data;
};
...
//# sourceMappingURL=_19peyqj._.js.map